...
@Mock([User, Build, Project, Machine, JavaInstall])
class BuildRestControllerSpec extends Specification {
	...
	def setup() {
		...
		def b1 = new Build(task: "clean", outcome: "Success", err_msg: "", time: "1.123", project_dir: "C:\\dir", ver: "1.0", grp: "com.iadams.BuildMgmt", javaInstall: javaInstall1, user: joe, machine: laptop, project: exampleProj1).save(failOnError: true)
		def b2 = new Build(task: "build", outcome: "Failed", err_msg: "Didn't work", time: "1.123", project_dir: "C:\\dir", ver: "1.0", grp: "com.iadams.BuildMgmt", javaInstall: javaInstall1, user: joe, machine: laptop, project: exampleProj1).save(failOnError: true)
	}
}